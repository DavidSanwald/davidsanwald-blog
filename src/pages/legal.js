...
const LegalNotice = ({ location, data }) => {
  const { site } = data
  ...
  return (
    <Layout location={location} title={site.siteMetadata.title}>
      ...
      <main>
        ...
        Telephone: 015780473068
        <br />
        E-Mail:{" "}
        <Styled.a href="mailto:why.ever.not.berlin@gmail.com">
          why.ever.not.berlin@gmail.com
        </Styled.a>
        <br />
        Internet address:{" "}
        <Styled.a href="www.davidsanwald.net" target="_blank" rel="noreferrer">
          www.davidsanwald.net
        </Styled.a>
        <br />
        <br />
        <h2>Disclaimer</h2>
        ...
        <Styled.a
          ...
          rel="noreferrer"
        >
          Übersetzungsbüro translate-24h.de
        </Styled.a>{" "}
        <br />
        <br />
      </main>
      <Footer socialLinks={siteMetadata.social} />
    </Layout>
  )
}
